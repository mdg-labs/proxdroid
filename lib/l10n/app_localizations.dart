...
abstract class AppLocalizations {
  ...
  /// Preferences: force app UI language to English.
  ///
  /// In en, this message translates to:
  /// **'English'**
  String get settingsLanguageEnglish;

  /// Preferences: force app UI language to German.
  ///
  /// In en, this message translates to:
  /// **'German'**
  String get settingsLanguageGerman;

  /// Preferences section: app UI language.
  ///
  /// In en, this message translates to:
  /// **'Language'**
  String get settingsLanguageSection;

  /// Preferences: follow the device language when supported.
  ///
  /// In en, this message translates to:
  /// **'System default'**
  ...
  /// Subtitle for Settings row that opens Preferences (appearance + language + charts).
  ///
  /// In en, this message translates to:
